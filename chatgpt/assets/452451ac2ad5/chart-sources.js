...
export function chartSource(id){
  if(id==='kospi'||id==='kosdaq')return {url:'https://finance.naver.com/sise/sise_index.naver?code='+id.toUpperCase(),provider:'네이버 금융',kind:'chart',note:'국내 지수는 네이버 금융에서 확인합니다. 1일·3개월·1년·3년 그래프를 선택할 수 있습니다. 카드와 시세 기준 시각은 다를 수 있습니다.'};
