// v 20260907-2200  nav.js — 모든 화면 공통 '읽는 순서' 길잡이. <header> 바로 아래에 ①→⑤ 띠를 붙이고, 지금 화면을 표시하고, '여기서 볼 것'과 '다음 →' 을 보여준다.
...
(function () {
  var NAV = [
    ...
    { id: 'predict', n: '④', name: '예측·채점', file: 'predict.html', what: '내 예측을 적고 오픈북으로 채점', look: '예측 JSON 만들기 → 저장 → 다음날 채점 결과·신뢰도' },
